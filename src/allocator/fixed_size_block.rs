...
impl FixedSizeBlockAllocator {
  ...
  /// and that the heap is unused. This function must only be called once.
...
/// Returns an index into `BLOCK_SIZES` for the given layout, or `None` if the layout is too large.
